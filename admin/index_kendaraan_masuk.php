            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav ">
                    ...
                    <li class="nav-item" style="border-bottom: 1px solid white;">
                        <a class="nav-link active" href="hapus_kendaraan_masuk.php">Kendaraan Masuk</a>
                    </li>
                    <li class="nav-item ">
        ...
        <div class="container-fluid mt-4">
            <div class="card">
                <div class="card-header bg-primary">
                    <div class="row">
                        <div class="col-6">
                            <h3 class="text-white">Daftar Kendaraan Masuk</h3>
                        </div>
                        <div class="col-6">
                            <a href="tambah_kendaraan_masuk.php" class=" btn btn-success float-end"><i class="fas fa-plus me-2"></i>Tambah Data</a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            include '../koneksi.php';
                            $no = 1;
                            $data = mysqli_query($konek, "SELECT a.*, b.* FROM kendaraan_masuk a join jenis_kendaraan b on a.jenis_kendaraan=b.id_jns_kendaraan where a.status_parkir = '1'");
                            // var_dump($data);
                            // die;
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td scope="row" class="text-center">
                                        ...
                                        <a class="btn btn-danger ml-2" onclick="return confirm('Ada yakin ingin menghapus data parkir dengan nomor polisi   : <?= $kendaraan_masuk['plat_no'] ?>')" href="hapus_kendaraan_masuk.php?id=<?= $kendaraan_masuk['id_parkir']; ?>">Hapus</a>
                                    </td>
